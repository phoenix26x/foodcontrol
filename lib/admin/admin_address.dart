...
import '../setting.dart';
import 'admin_address2.dart';
import 'admin_address_detail.dart';

class UserAddressAdmin extends StatefulWidget {
  final String username;

  const UserAddressAdmin({super.key, required this.username});

  @override
  State<UserAddressAdmin> createState() => UserAddressAdminState();
}

class UserAddressAdminState extends State<UserAddressAdmin> {
  ...
  Future<void> _navigateToAddressDetails(Map<String, dynamic> addressData) async {
    final updatedAddress = await Navigator.push(
      context,
      MaterialPageRoute(
        builder: (context) => AddressDetailsAdmin(
          ...
          ElevatedButton(
            onPressed: () {
              Navigator.push(
                context,
                MaterialPageRoute(
                  builder: (context) => UserAddressEditAdmin(
