...
class UserAddressEditAdmin extends StatelessWidget {
  final String username;
  final Function(Map<String, dynamic> updatedAddress) onUpdate;

  const UserAddressEditAdmin({super.key, required this.username, required this.onUpdate});
