...
class AddressDetailsAdmin extends StatefulWidget {
  final Map<String, dynamic> addressData;
  final Function(Map<String, dynamic>) onUpdate;

  const AddressDetailsAdmin({super.key, required this.addressData, required this.onUpdate});

  @override
  _AddressDetailsAdminState createState() => _AddressDetailsAdminState();
}

class _AddressDetailsAdminState extends State<AddressDetailsAdmin> {
