...
class FoodDetailsPageAdmin extends StatefulWidget {
  final Map<String, dynamic> entry;

  FoodDetailsPageAdmin({required this.entry, required username, required datetime});

  @override
  State<FoodDetailsPageAdmin> createState() => _FoodDetailsPageAdminState();
}

class _FoodDetailsPageAdminState extends State<FoodDetailsPageAdmin> {
