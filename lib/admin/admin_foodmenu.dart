...
class FoodMenuPageAdmin extends StatefulWidget {
  final String username;
  final int locationId;

  FoodMenuPageAdmin({required this.username, required this.locationId});

  @override
  _FoodMenuPageAdminState createState() => _FoodMenuPageAdminState();
}

class _FoodMenuPageAdminState extends State<FoodMenuPageAdmin> {
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      appBar: AppBar(
        ...
        //           context,
        //           MaterialPageRoute(
        //               builder: (context) => HomePage(username: widget.username,locationId: widget.locationId,)
        //               ),
        //             );
        //       },
        //       icon: Icon(
