...
class OrderDetailsPageAdmin extends StatefulWidget {
  ...
  @override
  _OrderDetailsPageAdminState createState() => _OrderDetailsPageAdminState();
}

class _OrderDetailsPageAdminState extends State<OrderDetailsPageAdmin> {
