...
void main() => runApp(const MaterialApp(home: AddFoodMenuPageAdmin()));

class AddFoodMenuPageAdmin extends StatefulWidget {
  const AddFoodMenuPageAdmin({super.key});

  @override
  _AddFoodMenuPageAdminState createState() => _AddFoodMenuPageAdminState();
}

class _AddFoodMenuPageAdminState extends State<AddFoodMenuPageAdmin> {
  File? _image;
  ...
  if (response.statusCode == 200) {
        ...
        actions: [
          CupertinoDialogAction(
            ...
            onPressed: () {
              ...
              Navigator.of(context).pop(); // ปิดหน้าปัจจุบัน (AddFoodMenuPageAdmin)
            },
          ),
        ],
      ),
    ...
    Navigator.of(context).pushReplacement(
      MaterialPageRoute(
        builder: (context) => FoodMenuAdmin(username: '',),
      ),
    );
  } else {
