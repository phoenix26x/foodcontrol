...
class FoodMenuAdminDetail extends StatefulWidget {
  final dynamic menuItem;

  const FoodMenuAdminDetail({Key? key, required this.menuItem}) : super(key: key);

  @override
  _FoodMenuAdminDetailState createState() => _FoodMenuAdminDetailState();
}

class _FoodMenuAdminDetailState extends State<FoodMenuAdminDetail> {
  ...
  void _editMenuItem(BuildContext context) {
    ...
    Navigator.of(context).push(
      MaterialPageRoute(
        builder: (context) => EditMenuAdminPage(menuItem: widget.menuItem),
      ),
    ).then((value) {
