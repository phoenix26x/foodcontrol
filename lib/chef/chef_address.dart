...
import '../setting.dart';
import 'chef_address2.dart';
import 'chef_address_detail.dart';

class UserAddressChef extends StatefulWidget {
  final String username;

  const UserAddressChef({super.key, required this.username});

  @override
  State<UserAddressChef> createState() => UserAddressChefState();
}

class UserAddressChefState extends State<UserAddressChef> {
  ...
  Future<void> _navigateToAddressDetails(Map<String, dynamic> addressData) async {
    final updatedAddress = await Navigator.push(
      context,
      MaterialPageRoute(
        builder: (context) => AddressDetailsChef(
          ...
          ElevatedButton(
            onPressed: () {
              Navigator.push(
                context,
                MaterialPageRoute(
                  builder: (context) => UserAddressEditChef(
