...
class OrderDetailsPageChef extends StatefulWidget {
  final String username;
  final String datetime;

  const OrderDetailsPageChef({
    Key? key,
  ...
  @override
  _OrderDetailsPageChefState createState() => _OrderDetailsPageChefState();
}

class _OrderDetailsPageChefState extends State<OrderDetailsPageChef> {
