// ignore_for_file: use_key_in_widget_constructors, prefer_const_constructors_in_immutables, library_private_types_in_public_api, prefer_const_constructors, unused_import
...
import '../setting.dart';
import 'chef_profile_edit.dart';

class ProfilePageChef extends StatefulWidget {
  final String username;

  ProfilePageChef({required this.username});
                          ...
                          ElevatedButton(
                            onPressed: () {
                              Navigator.push(
                                ...
                                MaterialPageRoute(
                                  builder: (context) =>
                                      EditProfilePageChef(username: widget.username),
                                ),
                              );
                            },
