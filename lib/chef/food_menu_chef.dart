...
import 'insert_menu_chef.dart';
import 'menu_chef_detail.dart';

class FoodMenuChef extends StatefulWidget {
  final String username;

  const FoodMenuChef({Key? key, required this.username}) : super(key: key);

  @override
  _FoodMenuChefState createState() => _FoodMenuChefState();
}

class _FoodMenuChefState extends State<FoodMenuChef> {
        ...
        return GestureDetector(
          onTap: () {
            Navigator.push(
              ...
              MaterialPageRoute(
                builder: (context) =>
                    FoodMenuChefDetail(menuItem: menuData[index]),
              ),
            ).then((value) {
