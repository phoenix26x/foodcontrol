...
import '../setting.dart';
import 'rider_about_1.dart'; // เพิ่มการนำเข้าไฟล์ uer_about_1.dart

class AboutRider extends StatelessWidget {
  final Map<String, dynamic>? updatedData;

  AboutRider({Key? key, this.updatedData}) : super(key: key);

  @override
  Widget build(BuildContext context) {
    return _AboutRider(updatedData: updatedData);
  }
}

class _AboutRider extends StatefulWidget {
  final Map<String, dynamic>? updatedData;

  _AboutRider({Key? key, this.updatedData}) : super(key: key);

  @override
  _AboutUserState createState() => _AboutUserState();
}

class _AboutUserState extends State<_AboutRider> {
              ...
              children: [
                ...
                ElevatedButton(
                  onPressed: () {
                    Navigator.push(
                      context,
                      MaterialPageRoute(builder: (context) => AboutRider1()),
                    );
                  },
                  style: ButtonStyle(
