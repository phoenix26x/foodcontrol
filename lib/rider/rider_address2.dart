...
class UserAddressEditRider  extends StatelessWidget {
  final String username;
  final Function(Map<String, dynamic> updatedAddress) onUpdate;

  const UserAddressEditRider ({super.key, required this.username, required this.onUpdate});
