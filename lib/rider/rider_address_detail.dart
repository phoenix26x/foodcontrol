...
class AddressDetailsRider extends StatefulWidget {
  final Map<String, dynamic> addressData;
  final Function(Map<String, dynamic>) onUpdate;

  const AddressDetailsRider({super.key, required this.addressData, required this.onUpdate});

  @override
  _AddressDetailsRiderState createState() => _AddressDetailsRiderState();
}

class _AddressDetailsRiderState extends State<AddressDetailsRider> {
