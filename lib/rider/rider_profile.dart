...
import 'package:zzz/rider/rider_profile_edit.dart';
...
class ProfilePageRider extends StatefulWidget {
  ...
  ProfilePageRider({required this.username});

  @override
  _ProfilePageRiderState createState() => _ProfilePageRiderState();
}
                          ...
                          ElevatedButton(
                            onPressed: () {
                              Navigator.push(
                                ...
                                MaterialPageRoute(
                                  builder: (context) =>
                                      EditProfilePageRider(username: widget.username),
                                ),
                              );
                            },
