...
class EditProfilePageRider extends StatefulWidget {
  final String username;
  const EditProfilePageRider({super.key, required this.username});

  @override
  _EditProfilePageRiderState createState() => _EditProfilePageRiderState();
}

class _EditProfilePageRiderState extends State<EditProfilePageRider> {
