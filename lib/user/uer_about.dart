...
import '../setting.dart';
import 'uer_about_1.dart'; // เพิ่มการนำเข้าไฟล์ uer_about_1.dart

class AboutUser extends StatelessWidget {
  final Map<String, dynamic>? updatedData;

  AboutUser({Key? key, this.updatedData}) : super(key: key);

  @override
  Widget build(BuildContext context) {
    return _AboutUser(updatedData: updatedData);
  }
}

class _AboutUser extends StatefulWidget {
  final Map<String, dynamic>? updatedData;

  _AboutUser({Key? key, this.updatedData}) : super(key: key);

  @override
  _AboutUserState createState() => _AboutUserState();
}

class _AboutUserState extends State<_AboutUser> {
              ...
              children: [
                ...
                ElevatedButton(
                  onPressed: () {
                    Navigator.push(
                      context,
                      MaterialPageRoute(builder: (context) => AboutUser1()),
                    );
                  },
                  style: ButtonStyle(
