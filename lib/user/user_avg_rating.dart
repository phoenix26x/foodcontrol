...
class avgRatingUser extends StatefulWidget {
  final String username;

  avgRatingUser({required this.username});

  @override
  _avgRatingUserState createState() => _avgRatingUserState();
}

class _avgRatingUserState extends State<avgRatingUser> {
  ...
  Widget build(BuildContext context) {
    ...
    totalRating = (restaurantAvgRating +
        tasteAvgRating +
              ...
              child: Padding(
                ...
                child: Column(
                  children: [
                    ...
                    Text(
                      'คะแนนรวม: ${totalRating.toStringAsFixed(2)}/20.00',
                      style: TextStyle(fontSize: 20),
                    ),
                    SizedBox(
                      height: 5,
                ...
                child: Padding(
                  ...
                  child: Column(
                    ...
                    children: [
                      ...
                      RatingBar.builder(
                        initialRating:
                            double.parse(userRatings[username]['emp_point']),
                        minRating: 1,
                        direction: Axis.horizontal,
                        allowHalfRating: true,
                        itemCount: 5,
                      ...
                      // แสดงค่าเฉลี่ยของคะแนน
                      Text(
                        "คะแนนรวม: ${calculateUserAverageRating(userRatings[username]).toStringAsFixed(2)}/20.00",
                        style: TextStyle(fontSize: 20),
                      ),
                      SizedBox(
                        height: 5,
