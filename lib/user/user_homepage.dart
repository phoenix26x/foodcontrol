...
import 'package:zzz/user/resetpassword.dart';
import 'package:zzz/user/uer_about.dart';
import 'package:zzz/user/user_avg_rating.dart';
import 'package:zzz/user/user_cart.dart';
import 'package:zzz/user/user_foodmenu.dart';
import 'package:zzz/user/user_history.dart';
import 'package:zzz/user/user_profile.dart';
import 'package:zzz/user/user_promotion.dart';
import 'package:zzz/user/user_queue.dart';

import '../setting.dart';
import 'user_user_address.dart';
...
class HomePageUser extends StatefulWidget {
  ...
  HomePageUser({required this.username, required this.locationId});
            ...
            ListTile(
              ...
              onTap: () {
                Navigator.push(context, MaterialPageRoute(builder: (context) {
                  return ProfilePageUser(username: widget.username);
                }));
              },
            ),
            ListTile(
              ...
              onTap: () {
                Navigator.push(context, MaterialPageRoute(builder: (context) {
                  return UserAddressUser(username: widget.username);
                }));
              },
            ),
            ListTile(
                  ...
                  child: FutureBuilder<List<PromotionPage>>(
                    ...
                    builder: (context, snapshot) {
                      if (snapshot.connectionState == ConnectionState.waiting) {
                        ...
                        //Text('Error: ${snapshot.error}');//Text('Error: ${snapshot.error}');
                      } else {
