...
class select_detailUser extends StatefulWidget {
  final Map<String, dynamic> addressData;
  final Function(Map<String, dynamic>) onUpdate;

  const select_detailUser(
      {super.key, required this.addressData, required this.onUpdate});

  @override
  _select_detailUserState createState() => _select_detailUserState();
}

class _select_detailUserState extends State<select_detailUser> {
