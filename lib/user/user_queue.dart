...
class QueuePageUser extends StatefulWidget {
  @override
  _QueuePageUserState createState() => _QueuePageUserState();
}

class _QueuePageUserState extends State<QueuePageUser> {
